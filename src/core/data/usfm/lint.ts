...
export const LintErrorKeys = {
    ...
    duplicateIdMarker: "duplicateIdMarker",
    idMarkerNotAtFileStart: "idMarkerNotAtFileStart",
    isUnknownMarker: "isUnknownMarker",
    isUnknownCloseMarker: "isUnknownCloseMarker",
    chapterMetadataOutsideChapter: "chapterMetadataOutsideChapter",
    verseMetadataOutsideVerse: "verseMetadataOutsideVerse",
    missingChapterNumber: "missingChapterNumber",
    missingVerseNumber: "missingVerseNumber",
    missingSeparatorAfterMarker: "missingSeparatorAfterMarker",
    missingMilestoneSelfClose: "missingMilestoneSelfClose",
    misnestedCloseMarker: "misnestedCloseMarker",
    strayCloseMarker: "strayCloseMarker",
    paragraphBeforeFirstChapter: "paragraphBeforeFirstChapter",
    verseBeforeFirstChapter: "verseBeforeFirstChapter",
    noteSubmarkerOutsideNote: "noteSubmarkerOutsideNote",
