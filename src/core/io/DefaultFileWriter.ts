import {IDirectoryProvider, IDirectoryHandle} from "@/core/persistence/DirectoryProvider.ts";
...
export class FileWriter implements IFileWriter {
     ...
     */
    constructor(directoryProvider: IDirectoryProvider, baseDir: IDirectoryHandle) {
    ...
    async writeFile(filePath: string, contents: string): Promise<void> {
        const fileHandle = await this.directoryProvider.getHandle(`${this.baseDir.path}/${filePath}`);
