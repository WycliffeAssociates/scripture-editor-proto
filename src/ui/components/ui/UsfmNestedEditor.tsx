...
import {
    ...
    PopoverContent,
    PopoverTrigger,
} from "@/ui/components/primitives/popover.tsx";
...
import { USFM_NESTED_DECORATOR_TYPE } from "@/domain/editor/nodes/USFMNestedEditorDecorator.tsx";
            ...
            <PopoverContent className="w-80 space-y-2">
                <LexicalComposer initialConfig={nestedConfig}>
                    <RichTextPlugin
                        ...
                        placeholder={
                            <span className="text-gray-400">Enter note…</span>
                        }
                    />
                    <HistoryPlugin />
