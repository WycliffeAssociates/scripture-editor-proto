...
import { useProjectContext } from "@/ui/contexts/ProjectContext.tsx";
import { USFMElementNode } from "@/domain/editor/nodes/USFMElementNode.ts";
import { USFMDecoratorNode } from "@/domain/editor/nodes/USFMMarkerDecoratorNode.tsx";
import { USFMNestedEditorNode } from "@/domain/editor/nodes/USFMNestedEditorDecorator.tsx";
import { USFMTextNode } from "@/domain/editor/nodes/USFMTextNode.ts";
import { UseLineBreaks } from "@/domain/editor/plugins/AdjustLineBreaks.tsx";
import { DecoratorFocusPlugin } from "@/domain/editor/plugins/DecoratorFocus.tsx";
...
export function ReferenceEditor() {
    ...
    if (referenceProjectQuery.isError) {
        return (
            <div>
                Error loading reference project:{" "}
                {String(referenceProjectQuery.error)}
            </div>
        );
    }
