...
import { Label } from "@/ui/components/primitives/label.tsx";
import { useProjectContext } from "@/ui/contexts/ProjectContext.tsx";
import { lexicalToUSFM, moveDecoratorNode } from "@/lib/editorNodeFunctions.ts";
import { getSerializedLexicalNodes } from "@/lib/getEditorState.ts";
import { parseUSFM } from "@/lib/parse.ts";
...
import { ReferencePicker } from "../views/ProjectView.tsx";
...
export function Search() {
    const { projectSearchOptions, setProjectSearchOptions } =
        useProjectContext();
