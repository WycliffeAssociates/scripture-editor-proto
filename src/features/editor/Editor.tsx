...
export function Editor() {
  ...
  const wholeProjectMatchesSearch = useMemo(() => {
    ...
    const res =
      allFiles?.reduce<Record<string, ChapterSearchResult>>((acc, file) => {
    ...
    <div>
      ...
      <div className="flex gap-2">
        ...
        {editorRef.current && (
          <div className="w-1/3">
            <SearchResults
              wholeProjectMatchesSearch={wholeProjectMatchesSearch}
          ...
          Object.entries(chapterResults).map(([chapterId, matches]) =>
            matches.map((match, i) => (
              <li
                ...
                onKeyDown={() =>
                  handleResultClick(filePath, Number(chapterId), match)
                }
                onClick={() =>
                  handleResultClick(filePath, Number(chapterId), match)
                }
