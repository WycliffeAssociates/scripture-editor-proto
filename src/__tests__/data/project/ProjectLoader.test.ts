...
import { ProjectLoader } from "@/src-core/domain/project/ProjectLoader.ts";
import { ResourceContainerProjectLoader } from "@/src-core/domain/project/ResourceContainerProjectLoader.ts";
import { ScriptureBurritoProjectLoader } from "@/src-core/domain/project/ScriptureBurritoProjectLoader.ts";
...
vi.mock("@/src-core/domain/project/ResourceContainerProjectLoader.ts", () => ({
...
vi.mock("@/src-core/domain/project/ScriptureBurritoProjectLoader.ts", () => ({
