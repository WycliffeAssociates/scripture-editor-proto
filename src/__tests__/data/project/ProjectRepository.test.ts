...
class MockFile implements File {
    ...
    slice(start?: number, end?: number, contentType?: string): Blob { throw new Error("Method not implemented."); }
...
const mockDirectoryProvider: IDirectoryProvider = {
    ...
    getProjectSourceDirectory: vi.fn(),
    getSourceContainerDirectory: vi.fn(),
    getDerivedContainerDirectory: vi.fn(),
    newFileWriter: vi.fn(),
    newFileReader: vi.fn(),
    ...
    resourceContainerDirectory: Promise.resolve(new MockDirectoryHandle(`${MOCK_USER_DATA_DIR}/resources`)),
    internalSourceRCDirectory: Promise.resolve(new MockDirectoryHandle(`${MOCK_USER_DATA_DIR}/internal-sources`)),
    userProfileImageDirectory: Promise.resolve(new MockDirectoryHandle(`${MOCK_USER_DATA_DIR}/profile-images`)),
    versificationDirectory: Promise.resolve(new MockDirectoryHandle(`${MOCK_USER_DATA_DIR}/versification`)),
