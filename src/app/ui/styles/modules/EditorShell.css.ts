...
export const referenceEditorOuter = style({
  ...
  // Thin, themed scrollbar — the native one is too heavy for this panel.
  // Firefox uses scrollbar-width/-color; WebKit/Chromium (incl. the Tauri
  // webview) uses the ::-webkit-scrollbar pseudo-elements below.
  scrollbarWidth: "thin",
