...
export const popover = style({
  ...
  // Roomier than the default popover for vertical rhythm between the status
  // header, action, details, and account areas. (Literals — the spacing scale
  // jumps md→lg with nothing in between.)
  padding: "1.5rem",
  display: "flex",
