...
import {UseSearchReturn} from "@/app/ui/hooks/useSearch";
            ...
            rightSection={
              <Group gap={2} align="center">
                <Tooltip label="Match Case">
                  <ActionIcon
                    variant={search.matchCase ? "filled" : "subtle"}
                    onClick={() => search.setMatchCase((v) => !v)}
                  >
                ...
                <Tooltip label="Match Whole Word">
                  <ActionIcon
                    variant={search.matchWholeWord ? "filled" : "subtle"}
                    onClick={() => search.setMatchWholeWord((v) => !v)}
                  >
                    <WholeWord size={16} />
                  </ActionIcon>
                </Tooltip>
