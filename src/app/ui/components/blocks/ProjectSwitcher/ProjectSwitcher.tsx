  ...
  const projects = useMemo<ProjectSwitcherItem[]>(
    () =>
      [...allProjects]
        ...
        .sort((a, b) => {
          const byName = getProjectLabel(a).localeCompare(getProjectLabel(b));
          if (byName !== 0) return byName;
          return getProjectSubtitle(a).localeCompare(getProjectSubtitle(b));
        }),
    [allProjects],
  );
      ...
      <div className={styles.root}>
        ...
        >
          <div className={styles.triggerText}>
            <span className={styles.triggerKicker}>Current project</span>
