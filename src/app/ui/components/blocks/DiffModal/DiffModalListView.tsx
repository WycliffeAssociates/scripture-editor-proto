...
function DiffItem({
  ...
  const wordDiff = useMemo(() => {
    ...
    const currentComparisonText = shouldTrim
      ...
      : displayText.current;
    return diffWordsWithSpace(originalComparisonText, currentComparisonText);
  }, [
    ...
    <div data-testid={TESTING_IDS.save.diffItem} className={styles.diffItem}>
      <div className={styles.diffToolbarRow}>
        <div className={styles.diffToolbarGroup}>
          ...
          {diff.isWhitespaceChange && (
            <span className={`${styles.diffBadge} ${styles.diffBadgeGray}`}>
              <Trans>Whitespace Only</Trans>
            </span>
          )}
          {diff.isUsfmStructureChange && (
            <span className={`${styles.diffBadge} ${styles.diffBadgePrimary}`}>
        ...
        <div className={styles.diffGrid}>
          <div className={styles.diffColumn}>
            ...
            >
              ...
              {isDeletion && (
                <pre className={styles.diffPre}>{displayText.original}</pre>
              )}
          ...
          <div className={styles.diffColumn}>
            ...
            >
              ...
              {isAddition && (
                <pre className={styles.diffPre}>{displayText.current}</pre>
              )}
              {isModification && wordDiff && (
                <HighlightedDiffText
                  changes={wordDiff}
          ...
          return (
            ...
            >
              <DiffItem
                ...
                effectiveShowUsfmMarkers={effectiveShowUsfmMarkers}
