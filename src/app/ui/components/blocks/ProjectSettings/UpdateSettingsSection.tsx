...
function UpdateSettingsBody({
  ...
  const handleSwitch = async () => {
    ...
    const isDowngrade = compareSemverLoose(selectedVersion, currentVersion) < 0;
    if (
      isDowngrade &&
      !window.confirm(
    ...
    <div className={styles.section}>
      <div className={styles.sectionRow}>
        <div className={styles.rowText}>
          ...
          {checkStatus ? (
            <div className={styles.rowDescription}>{checkStatus}</div>
          ) : null}
        </div>
        <div className={styles.rowControl}>
          ...
          >
            {recheck.isPending ? t`Checking…` : t`Check for updates`}
          </Button>
        </div>
      </div>
      ...
      {update ? (
        <div className={styles.sectionRow}>
          <div className={styles.rowText}>
            ...
            <div className={styles.rowDescription}>
              <Trans>v{update.version} is ready to install.</Trans>
            </div>
          </div>
          <div className={styles.rowControl}>
      ...
      <div className={styles.sectionRow}>
        <div className={styles.rowText}>
          ...
          <div className={styles.rowDescription}>
            <Trans>
              Install a specific release for this channel. Older picks will
              downgrade the app.
            </Trans>
          </div>
        </div>
        <div className={styles.rowControl}>
          <SelectPrimitive
            ...
            disabled={
              switching || versionsQuery.isLoading || selectItems.length === 0
            }
            portalContainer={portalContainer}
