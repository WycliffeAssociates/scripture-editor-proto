...
export function FormBlockCard(props: FormBlockCardProps) {
    ...
    if (kind.variant === "heading") {
        return (
            <HeadingBlock fragments={fragments} direction={props.direction} />
        );
    }
                ...
                return (
                    <Fragment key={fragment.id}>
                        ...
                        <FragmentRow
                            ...
                            onSplitBlockAtCursor={props.onSplitBlockAtCursor}
                            onInsertBelow={props.onInsertBelow}
                            onInsertVerseBeforeFragment={
                                props.onInsertVerseBeforeFragment
                            }
                        />
                        {!props.readOnly && nextIsVerseStart && nextFragment ? (
                            <SplitGap
                                onSplit={() =>
                                    props.onSplitBeforeFragment(
                                        nextFragment,
                                        "p",
                                    )
                                }
            ...
            <div className={fieldClassName}>
                ...
                {props.readOnly ? (
                    ...
                    <AutoTextarea
                        ...
                        minHeightPx={
                            props.fragment.text.length === 0 ? 0 : undefined
                        }
                    />
                )}
                {isInvalid ? (
