...
export function SourcePicker(props: SourcePickerProps) {
    ...
    const { repos, isLoading, isError, errorMessage } =
        useConsolidatedCatalog();
                ...
                <div className={styles.searchBar}>
                    ...
                    <div className={styles.fieldWrap}>
                        <SelectPrimitive
                            ...
                            onValueChange={(value) =>
                                setField(
                                    (value as SearchField) ?? DEFAULT_FIELD,
                                )
                            }
                        ...
                        <div className={styles.stateWrap}>
                            {normalizedQuery.length > 0 ? (
                                <>
                                    ...
                                    <p className={styles.stateText}>
                                        <Trans>
                                            Double-check your spelling, or try
                                            removing any active filters to
                                            broaden your search.
                                        </Trans>
                                    </p>
                                    ...
                                    <div className={styles.callout}>
                                        ...
                                        <p className={styles.calloutText}>
                                            <Trans>
                                                You can paste a repository link
                                                from WACS directly into the
                                                search bar.
                                            </Trans>
                                        </p>
                                    </div>
        ...
        case "not-consolidated":
            return (
                <div className={styles.stateWrap}>
                    ...
                    <p className={styles.stateText}>
                        <Trans>
                            {repoLabel} isn't tagged "consolidated", so it isn't
                            available to import here.
                        </Trans>
                    </p>
                </div>
            );
        case "not-found":
            return (
                <div className={styles.stateWrap}>
                    ...
                    <p className={styles.stateText}>
                        <Trans>
                            Couldn't find a public repository at this link.
                        </Trans>
                    </p>
                </div>
            );
