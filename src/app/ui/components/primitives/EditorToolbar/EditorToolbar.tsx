...
import EditorModeToggle from "@/app/ui/components/blocks/ProjectSettings/EditorModeToggle.tsx";
...
export function EditorToolbar(props: EditorToolbarProps) {
        ...
        editor.update(
          () => {
            ...
            selection.insertNodes(
              parsedUsfmTokensToInsertableNodes(
                parsed.tokens,
                editorModeToShape(project.appSettings.editorMode),
              ),
            );
          },
          { discrete: true },
  ...
  const [pickReferenceDialogOpen, setPickReferenceDialogOpen] = useState(false);
  ...
  return (
    <div className={styles.shell}>
      <div className={styles.titleRow}>
        ...
        >
          <span className={styles.currentLocationBook}>{currentBookLabel}</span>
          <span className={styles.currentLocationChapter}>
            {project.pickedChapter?.chapterNumber}
          </span>
        </div>
        <EditorModeToggle className={styles.modePickerInline} />
      </div>
        ...
        <div className={styles.toolbarRow}>
          <div className={styles.rightGroup}>
            ...
            <ToolbarOverflowMenu
              ...
              onMatchFormattingToSource={handleMatchFormattingToSource}
              onCopyEditorJson={
                import.meta.env.DEV
              ...
              >
                ...
                >
                  ...
                  <div className={dialogStyles.dialogActions}>
                    <Button
                      variant="secondary"
                      onClick={() => setPickReferenceDialogOpen(false)}
                    >
                      {t`Cancel`}
                    </Button>
                    <Button
                    ...
                    >
                      <span className={styles.dialogButtonContent}>
                        {dialogReferenceLoading ? (
                          <span className={styles.dialogSpinner}>
                            <Loader2 size={14} />
                          </span>
                        ) : null}
                        {t`Match formatting`}
