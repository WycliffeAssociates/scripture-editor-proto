...
export function ProjectList() {
  ...
  return (
    <div data-testid={TESTING_IDS.appDrawer.projectsList}>
      ...
      >
        {Object.entries(groupedProjects).map(([languageName, projects]) => (
          <div key={languageName}>
            ...
            >
              {projects.map((proj) => {
                ...
                const picked = diskProjectName === currentProjectRoute;
                return (
                  <div
                    key={proj.folderName}
                  ...
                  >
                    <Button
                      variant="tertiary"
                      className={classnames.projectButton}
                      onClick={() => navigateToProject(proj.projectPath)}
                      aria-label={`Open project ${proj.displayName}`}
                      data-testid={TESTING_IDS.project.listItemButton}
                    >
                      <span
                        style={{
