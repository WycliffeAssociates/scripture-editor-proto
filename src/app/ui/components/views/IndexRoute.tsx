...
/**
 * Home/library landing view for editable scripture items.
 *
 * The broader index/catalog can contain more item types, but this view presents
        ...
        <header className={styles.header}>
          <div className={styles.headerCopy}>
            ...
            <p className={styles.description}>
              <Trans>Open an existing project, or create a new one.</Trans>
            </p>
          </div>
          ...
          <section className={styles.groups}>
            {Object.entries(byLanguage)
              ...
              .map(([languageName, projectsForLanguage]) => (
                <section key={languageName} className={styles.group}>
                  <h2 className={styles.groupTitle}>{languageName}</h2>
