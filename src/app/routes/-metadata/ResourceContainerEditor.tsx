    ...
    <div className={styles.metadataSection}>
      ...
      <div className={styles.metadataHeader}>
        ...
        {suggestedProjects.length > 0 ? (
          <Button size="xs" variant="light" onClick={applyAllSuggestedProjects}>
      ...
      <Table striped withBorder>
        ...
        <TableBody>
          {draft.projects.map((project, index) => {
            ...
            return (
              <Fragment key={`${project.identifier}-${project.title}-${index}`}>
                <TableRow>
                  <TableCell>
                    <TextInput
                      value={project.title}
                      onChange={(event) =>
                        updateProject(index, "title", event.currentTarget.value)
                      }
                    />
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <TextInput
                      value={project.sort}
                      onChange={(event) =>
                        updateProject(index, "sort", event.currentTarget.value)
                      }
                    />
                  </TableCell>
                  <TableCell>
                    <TextInput
                      value={project.path}
                      onChange={(event) =>
                        updateProject(index, "path", event.currentTarget.value)
                      }
                    />
                  </TableCell>
                </TableRow>
                {hasSuggestion ? (
                  <TableRow>
                    ...
                    <TableCell>
                      ...
                      >
                        Suggested:{" "}
                        {project.suggestedSort ?? project.sort ?? "(empty)"}
                      </span>
                    </TableCell>
                    <TableCell>
                      <div
                      ...
                      >
                        ...
                        >
                          Suggested:{" "}
                          {project.suggestedPath ?? project.path ?? "(empty)"}
                        </span>
                        <Button
                          size="xs"
                          variant="tertiary"
                          onClick={() => applySuggestedProject(index)}
                        >
                          Apply
                        </Button>
                      </div>
