...
export const sharedProjectLabels = {
  ...
  autoSendTitle: msg`Send my changes on save`,
  autoSendDescription: msg`When you save, send your changes to the shared project.`,
  autoReceiveTitle: msg`Check for changes on open`,
  autoReceiveDescription: msg`When you open this project, check the shared project for new changes.`,
  autoAcceptOwnTitle: msg`Skip review of my changes`,
  autoAcceptOwnDescription: msg`Save your changes to the project directly, without reviewing them first.`,
  autoAcceptIncomingTitle: msg`Skip review of incoming changes`,
  autoAcceptIncomingDescription: msg`Accept changes from the shared project automatically — unless they touch content you've also edited but not yet saved.`,
