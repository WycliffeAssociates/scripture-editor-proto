...
describe("WebDirectoryHandle", () => {
  ...
  test("getDirectoryHandle with path containing consecutive slashes is normalized", async () => {
    ...
    const dirHandle = await rootWrapper.getDirectoryHandle("//test//dir//", {
      create: true,
    });
  ...
  test("getFileHandle handles deep relative parent paths (e.g., ../../../)", async () => {
    ...
    const newDirHandle = await cWrapper.getDirectoryHandle(newDirRelativePath, {
      create: true,
    });
  ...
  test("getFileHandle handles deep relative parent paths (e.g., ../../../)", async () => {
    ...
    const newFileHandle = await zWrapper.getFileHandle(newFileRelativePath, {
      create: true,
    });
