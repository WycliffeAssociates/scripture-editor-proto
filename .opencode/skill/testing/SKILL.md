...
- **Avoid Implementation Details:** Do not test internal state, private methods, or specific class names. Test the _observable output_ (rendered DOM, disk IO, return values).
- **The User is King:** Tests should resemble how the software is used.
  - _Unit:_ Input -> Output.
  - _Integration:_ Component + Providers + DOM interaction.
  - _E2E:_ Full app flow.
