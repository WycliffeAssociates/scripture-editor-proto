...
describe("LibraryItem type definitions", () => {
    ...
    it("defines UsfmScriptureItem with type-specific verbs", () => {
        ...
        expectTypeOf(scriptureItem.readBook).parameters.toEqualTypeOf<[bookCode: string]>();
    });
    ...
    it("defines TranslationNotesItem with TN-specific verbs", () => {
        ...
        expectTypeOf(tnItem.readChapter).parameters.toEqualTypeOf<[bookCode: string, chapterNumber: number]>();
    });
    ...
    it("capabilities compose on LibraryItemBase", () => {
        ...
        expect(fullyCapableItem.capabilities.anchorNavigation?.kind).toBe("anchorNavigation");
    });
    ...
    it("TranslationNotesItem verbs are type-specific (not on scripture)", () => {
        ...
        expectTypeOf(scriptureItem).not.toMatchTypeOf<{ listBookCodes?: unknown }>();
    ...
    it("capability guards narrow types correctly for type-specific operations", () => {
        ...
        if (isRemoteSyncCapable(syncCapableTn)) {
            expectTypeOf(syncCapableTn.capabilities.remoteSync).toMatchTypeOf<RemoteSyncCapability>();
